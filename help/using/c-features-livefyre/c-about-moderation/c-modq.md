...
* Moderar en contexto, ver subprocesos completos y Aprobar, Papelera o Bozo, ya sea fragmentos individuales de contenido o subprocesos completos con un solo clic.
...
El contenido de Livefyre aparece en ModQ durante un máximo de 6 semanas y el contenido de flujos premoderado que no se ha abordado se muestra en ModQ durante 90 días.
...
* **[!UICONTROL Items]** enumera todo el contenido de Livefyre-native y SocialSync programado para moderación. Esta ficha incluye cualquier contenido de búsqueda social o flujo que se haya marcado o editado tras la moderación.
* **[!UICONTROL Streams Premoderation]** enumera todo el contenido que entra en las aplicaciones desde flujos con Premoderado habilitado. (Para obtener más información, consulte Creación de flujos).
...
* **[!UICONTROL History]** Haga clic en el **[!UICONTROL History]** botón en la parte superior derecha de la pantalla para abrir una lista de contenido moderado recientemente, que le permitirá revisar su trabajo o cambiar una acción de moderación reciente. Vuelva a hacer clic en el botón para volver al contenido en cola. Solo se mostrarán las 100 acciones más recientes. **El historial** no enumerará las acciones realizadas por otro moderador.
...
Cada fragmento de contenido de la lista muestra información de vista previa, incluido el sitio en el que se publicó y su autor. Al seleccionar un elemento se mostrará todo el contenido, incluidos los medios.
...
* **[!UICONTROL Time in Queue:]** indica la cantidad de tiempo que se agregó el contenido a ModQ.
* **[!UICONTROL App name:]** la aplicación en la que aparece el contenido. Vínculos al sitio con la aplicación.
* **[!UICONTROL Content Body:]** texto y miniatura de medios, si están disponibles.
...
* **[!UICONTROL Timestamp:]** la marca de tiempo relativa de cuándo se creó el contenido. Permite vincular el contenido de la página Contenido de la aplicación de Studio.
* **[!UICONTROL Flag Type:]** Ofensiva, en desacuerdo, spam, etc.

   * Indicadores SAFE: Correo no deseado y masivo.
   * Indicador aplicado por la lista de beneficios de la red y del sitio: Profanidad.
   * Indicadores aplicados por SAFE: Discurso de odio, PII (Información de Identificación Personal), Insulto y Profanidad.
   * Indicadores de usuario: Correo no deseado, fuera de tema, Ofensiva y Rechazo.

* **[!UICONTROL Flag origin:]** el origen del indicador de la lista. Puede ser SAFE, un nombre de usuario o Livefyre.
* **[!UICONTROL More info:]** enumera los detalles del contenido, incluido el número de "Me gusta", Marcas de usuario, Respuestas y cualquier etiqueta aplicada al contenido. Al hacer clic en el sitio se abre la página de nivel superior del sitio en el que se encuentra el contenido. Al hacer clic en la marca de tiempo, se abre una vista de proceso del contenido en contexto en la página.

## Opciones de filtro en ModQ {#section_r2c_qc2_yy}

Haga clic **[!UICONTROL Filter]** en la parte superior izquierda de la ventana de ModQ para abrir un panel con opciones de filtro disponibles para el contenido de la lista. A medida que seleccione las opciones, ModQ se actualizará automáticamente para enumerar únicamente el contenido filtrado. Haga clic en **[!UICONTROL Clear filters]** para borrar todas las opciones seleccionadas y vuelva a cargar la lista completa de elementos.
...
* **[!UICONTROL System Flags]**. Filtre el contenido por reglas como Correo no deseado, Profanidad, SAFE y Premoderación.
   ...
   * Al seleccionar **[!UICONTROL Profanity]** se enumerarán todos los contenidos etiquetados como Promedio por su Red o Lista de beneficios del sitio.
   * Al seleccionar **[!UICONTROL SAFE]** se enumerarán todos los contenidos que ingresan a ModQ como resultado de las reglas de SAFE.
   * Al seleccionar **[!UICONTROL Premoderation]** se enumerará todo el contenido etiquetado para la premoderación por la configuración de red, flujo o aplicación.
...
* **[!UICONTROL Entered the queue.]** Filtre el contenido según el intervalo de tiempo durante el cual se envió a ModQ. La hora en que se envió el contenido a ModQ no es necesariamente la hora en que se publicó en la aplicación.

En **[!UICONTROL Streams Premoderation]**:
...
* **[!UICONTROL Request Rights]** para solicitar los derechos del propietario del contenido al contenido.
   ...
   >[!NOTE]
   >
   >No se pueden solicitar derechos en ModQ para contenido desde Instagram. Debe usar la biblioteca o el contenido de la aplicación para enviar solicitudes de derechos de contenido desde Instagram.
...
>[!NOTE]
>
>Una vez que se deshace un fragmento de contenido, el fragmento de contenido y todas las respuestas al fragmento de contenido se eliminan de ModQ de forma permanente. Para colocar un fragmento de contenido desechado en una aplicación, consulte [Agregar un elemento con seguimiento de vuelta a una aplicación](/help/using/c-features-livefyre/c-about-moderation/t-add-trashed-item-back-into-app.md#t_add_trashed_item_back_into_app).
...
Haga clic en el **[!UICONTROL User actions]** botón del panel Resumen de usuarios para silenciar, prohibir o incluir en la lista blanca al usuario.
...
* **[!UICONTROL Ban:]** le permite prohibir el acceso del usuario de su sitio o red. (Solo los administradores de estudios o los administradores de usuarios pueden prohibir un usuario en la red).
* **[!UICONTROL Whitelist:]** le permite incluir en la lista blanca al usuario de su sitio o red. (Solo los administradores de estudios o los administradores de usuarios pueden incluir un usuario en la lista blanca de la red).
