...
* 22 de junio de 2020: terminará la capacidad de buscar nuevo contenido de Facebook en Livefyre.
* 7 de julio de 2020: finalizará el acceso al contenido guardado en la biblioteca de activos de Livefyre y el contenido de la aplicación.
* 10 de agosto de 2020: Se eliminará el contenido de facebook publicado en sitios web que residan en visualizaciones de Livefyre como muros de medios, tarjetas de características, mosaicos, carruseles y mucho más.

Este cambio no afecta al contenido de Instagram que seguirá siendo accesible en Livefyre.

También queremos compartir que, debido a la limitada demanda de contenido de Twitter por parte de los clientes, el acceso a Twitter se eliminará de Livefyre el próximo año, 3 de mayo de 2021. Hasta esta fecha, seguirá teniendo acceso completo al contenido nuevo y guardado de Twitter.
...
* Visite Configuración para volver a autorizar y actualizar los tokens de acceso vinculados a su cuenta de Instagram Business
* Espere de una a dos horas para que el contenido vuelva a transmitirse
* Póngase en contacto con soporte técnico si tiene algún problema

Las transmisiones de facebook aún no se han restaurado, pero seguimos trabajando activamente con Facebook para restablecer esta capacidad y le actualizaremos en cuanto sepamos más.
...
Tenga en cuenta que todavía hay maneras de acceder al contenido de Facebook y Instagram en este momento:
...
* **Buscar y transmitir contenido desde cuentas empresariales**

   La desaprobación de la API ha eliminado la capacidad de buscar cuentas personales de Instagram. Como alternativa, el equipo de Livefyre ha lanzado una funcionalidad que le permitirá buscar y transmitir contenido desde cuentas de negocios, incluidas las suyas.

* **Supervisión automática de las respuestas de solicitudes de derechos de uso para búsquedas basadas en cuentas empresariales**
...
* Publicar y guardar contenido de Instagram en carpetas y aplicaciones en Social Search
...
El jueves 3 de mayo de 2018, Facebook dejó de utilizar varias API de Instagram utilizadas por socios de terceros para acceder a diferentes aspectos del contenido de Instagram con el fin de proteger la privacidad personal y los datos de sus usuarios.

Agradecemos su paciencia mientras analizamos el impacto en el sistema Livefyre. La siguiente descripción general aclara qué capacidades de Livefyre siguen funcionando sin problemas y qué capacidades ha afectado la desaprobación de la API, y cómo y cuándo abordaremos los cambios.

En primer lugar, tenga la seguridad de que la mayoría de las funciones de Instagram de Livefyre no se verán afectadas. El contenido de instagram se puede transmitir mediante hashtag y ubicación, y se publicará en carpetas y aplicaciones de visualización de Livefyre. El contenido de transmisión de todas las demás fuentes (Twitter, Facebook, YouTube, Tumblr, RSS y correo electrónico) permanece sin cambios.

Después de un análisis completo del sistema, estas son las capacidades afectadas por la desaprobación de la API y las fechas en las que anticipamos que se solucionarán.

**Actualmente, las siguientes funciones no están disponibles y se espera que estén disponibles para el 17 de mayo de 2018:**

* Vea detalles, guarde y publique contenido de Instagram en carpetas y aplicaciones en Búsqueda social.
* Realice acciones sobre el contenido de Instagram en ModQ.

**Se espera que las fechas que se muestran a continuación pongan a disposición soluciones para la siguiente funcionalidad:**

* **Flujo de trabajo de solicitud de derechos de uso: 24 de mayo de 2018**

   Livefyre ya no puede enviar mensajes en nombre de una cuenta de usuario. La solicitud de derechos de uso para el contenido de Instagram ahora debe realizarse manualmente. Livefyre ofrece un sencillo flujo de trabajo de cortar y pegar para ayudar a los clientes a realizar el seguimiento de las aprobaciones y mantener registros de auditoría.
...
Lamentamos sinceramente cualquier perturbación que esto cause y le seguiremos informando de nuestros progresos a medida que abordemos estos cambios.
